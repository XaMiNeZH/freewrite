...
2. Click the timer
3. Turn on "No Backspace" in the bottom bar
4. Start writing. Don't stop writing.
...
2. Try to scroll on the timer — this is how you set a different timer.
...
3. There is no spellcheck. There is no markdown rendering. This is on purpose. It doesn't matter.
...
5. Click "History" on the bottom right to see all your entries. It's all saved locally as plain markdown files in your Documents/Freewrite folder — open them in any text editor you like.

Note: this is the Linux port. Video entries (with local transcription) exist in the macOS version but aren't here yet — that's a planned follow-up.

All your writing stays on your computer. Freewrite doesn't have analytics. It doesn't send your stuff anywhere, ever. It never leaves your machine.

We are fully open-source:
https://github.com/farzaa/freewrite

And, be sure to follow Farza here:
https://x.com/farzatv
